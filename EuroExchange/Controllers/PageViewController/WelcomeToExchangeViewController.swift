//
//  WelcomeToExchangeViewController.swift
//  EuroExchange
//
...
class WelcomeToExchangeViewController: UIViewController {
    //MARK: -Varibales-
    ...
    let passwordChangedLabel: UILabel = {
        let lbl = UILabel()
        lbl.text = "Welcome to Euro Exchange"
    ...
    let reputationLabel: UILabel = {
        let lbl = UILabel()
        lbl.text = "“Price is what you pay"
